...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.question_text = self.canvas.create_text(
            ...
            125,
            width=280,
            text="Aqui esta o quiz",
            fill=THEME_COLOR,
            font=("Arial", 20, "italic"),
        )
        #adicionar o pady para liberar o espaço entre o canva e os botoes
    ...
    def get_next_question(self):
        ...
        if self.quiz.still_has_questions():
            ...
            self.canvas.itemconfig(self.question_text, text="Voce terminou o Quiz")
